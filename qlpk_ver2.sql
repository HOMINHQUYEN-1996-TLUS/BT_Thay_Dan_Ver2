...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 29, 2022 lúc 02:16 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getLichSuKham` (IN `ID` VARCHAR(20))   select khachhang.ID_khachhang,data_history.TongTien, data_history.GiaCuoi, data_history.NgayThang,phongban.TenPhong,bacsi.HoTen
FROM ( ( ( data_history INNER join phongban
ON data_history.ID_PhongBan = phongban.ID_PhongBan ) inner join khachhang 
...
ORDER BY data_history.NgayThang ASC$$
...
--
-- Cấu trúc bảng cho bảng `data_history`
--

CREATE TABLE `data_history` (
  `data_history_id` int(10) UNSIGNED NOT NULL,
  `ID_HoaDon` varchar(20) DEFAULT NULL,
  `ID_bacsi` varchar(20) DEFAULT NULL,
  `ID_PhongBan` varchar(20) DEFAULT NULL,
  `NgayThang` varchar(100) DEFAULT NULL,
  `TongTien` int(11) DEFAULT NULL,
  `GiaCuoi` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Đang đổ dữ liệu cho bảng `data_history`
--

INSERT INTO `data_history` (`data_history_id`, `ID_HoaDon`, `ID_bacsi`, `ID_PhongBan`, `NgayThang`, `TongTien`, `GiaCuoi`) VALUES
(1, 'HD008', 'BS002', 'PB002', '10/01/1999', 500000, 450000),
(2, 'HD009', 'BS003', 'PB004', '23/02/2018', 900000, 810000);
...
('HD007', 'BS002', 'PB006', '28/03/2022', 900000),
('HD008', 'BS002', 'PB002', '10/01/1999', 500000),
('HD009', 'BS003', 'PB004', '23/02/2018', 900000);

--
-- Bẫy `hoadon`
--
DELIMITER $$
CREATE TRIGGER `data_insert_hoadon` AFTER INSERT ON `hoadon` FOR EACH ROW BEGIN
...
--
-- AUTO_INCREMENT cho bảng `data_history`
--
ALTER TABLE `data_history`
  MODIFY `data_history_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
